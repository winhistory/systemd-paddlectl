(function() {
	...
	breakout.logo = function() {
		Crafty.sprite(1, 'aprilfools-2015/media/logo.png', {
			logo: [0, 0, 131, 175]
		});
	...
	breakout._createBackgroundViaImage = function() {
		...
		Crafty.sprite(1, 'aprilfools-2015/media/bg_prerendered.png', {
			bg: [0, 0, width, height]
		});
	...
	breakout._createBackgroundViaTiles = function() {
		Crafty.sprite(16, 'aprilfools-2015/media/tiles.png', {
			r: [11, 3],
			l: [11, 4],
			v: [11, 5],
			h: [11, 6],
